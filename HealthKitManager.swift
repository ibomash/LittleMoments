...
class HealthKitManager {
    ...
    func createMindfulSession(startDate: Date, endDate: Date) -> HKCategorySample {
        ...
        let mindfulSessionInstance = HKCategorySample(type:mindfulSessionType, value: 0, start: startDate, end: endDate)
        
        return mindfulSessionInstance
    }

    // Save a Mindful Session to HealthKit
    func saveMindfulSession(mindfulSession: HKCategorySample, completion: @escaping (Bool, Error?) -> Swift.Void) {
