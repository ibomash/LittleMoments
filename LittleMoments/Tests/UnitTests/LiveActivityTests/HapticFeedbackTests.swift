...
final class HapticFeedbackTests: XCTestCase {
    ...
    func testProvideCompletionFeedbackDoesNotThrow() {
        ...
        XCTAssertNoThrow(manager.provideCompletionFeedback(), "Providing completion feedback should not throw")
    }
    ...
    func testLiveActivityManagerHasHapticFeedbackCapability() {
        ...
        XCTAssertNoThrow(manager.provideSessionCompletionFeedback(), "LiveActivityManager should have haptic feedback capability")
    }
    ...
    func testSessionCompletionWithHapticFeedback() {
        ...
        XCTAssertNoThrow(manager.completeSessionWithFeedback(), "Session completion with haptic feedback should not throw")
    }
    ...
    func testHapticFeedbackOnUnsupportedDevice() {
        ...
        XCTAssertNoThrow(manager.provideCompletionFeedback(), "Should handle unsupported devices gracefully")
    }
    ...
    func testHapticFeedbackWithSystemSettingsDisabled() {
        ...
        XCTAssertNoThrow(manager.provideCompletionFeedback(), "Should handle disabled system settings gracefully")
    }
